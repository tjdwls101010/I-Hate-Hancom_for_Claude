...
| ID | 테두리 | 배경색 | 용도 |
|----|--------|--------|------|
| 5 | 특수 (헤더 영역) | 없음 | 표 헤더 영역 셀 |
| 7–12 | 다양한 변형 | 없음 | 표 셀 변형 (상황별 선택) |

### 4-3. 어두운 배경 (흰색 텍스트 필수)
...
```
> borderFill 4 (SOLID 테두리) + paraPr 22 (CENTER, 130%) + charPr 136 (10pt 돋움체 BOLD)
> **이유**: 표 헤더는 가운데 정렬 + 굵은 글씨로 데이터 컬럼명을 명확히 한다. 줄간격 130%로 셀 높이를 절약.
